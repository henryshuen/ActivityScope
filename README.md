...
- Long press to remove items from favorites
...
- Long press to remove a single recent entry
- Toolbar action to clear the entire recent list with confirmation dialogs
...
1. Download the latest `app-release.apk` from the **Releases** page of this repository.
...
1. Clone this repository:
        ...
        git clone https://github.com/<your-username>/ActivityScope.git
        cd ActivityScope
...
- Long press an item to delete it from the history
- Use the toolbar action **Clear recent** to remove all items with confirmation

### Favorites

- Displays activities marked as favorites
- Useful for quick access to screens you open often
